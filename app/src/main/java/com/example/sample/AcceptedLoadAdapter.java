...
public class AcceptedLoadAdapter extends RecyclerView.Adapter<AcceptedLoadAdapter.ViewHolder> {
    private final RecyclerViewClickListener mListener;
    private List<Driver> listData;

    public AcceptedLoadAdapter(List<Driver> listData, RecyclerViewClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.content_accepted_load, parent, false);
