    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final ProgressDialog progressDialog = new ProgressDialog(Ridedetail.this);
                progressDialog.setMessage("Check Request List");
                progressDialog.show();

                Common.currentUser.setDate(date.getText().toString());
                Common.currentUser.setTime(time.getText().toString());
                Common.currentUser.setSpace(quantity.getText().toString());
                ...
                FirebaseDatabase.getInstance().getReference("Driver").child(Common.currentUser.getMobile()).setValue(Common.currentUser)
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                startActivity(new Intent(Ridedetail.this, Ddashboard.class));
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(Ridedetail.this, "Cannot Update!", Toast.LENGTH_SHORT).show();
                            }
                        });
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            case Date_id:
                ...
                return new DatePickerDialog(Ridedetail.this, date_listener, year,
                        month, day);
            case Time_id:

                // Open the timepicker dialog
                return new TimePickerDialog(Ridedetail.this, time_listener, hour,
                        minute, false);
